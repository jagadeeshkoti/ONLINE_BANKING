...
public class Opening_Accountand_DeletSame {
	...
	driver.findElement(By.xpath("//a[@class='staff_home']")).click();
	driver.findElement(By.xpath("//input[@value='View Active Customer']")).click();
	List<WebElement> allan = driver.findElements(By.xpath("//tbody/tr/td[4]"));
	String customer_Id=null;
	for (WebElement sac : allan) 
		{
			if(sac.getText().contains(num2))
			{
				customer_Id=driver.findElement(By.xpath("//tbody/tr/td[text()='"+num2+"']/preceding-sibling::td[1]")).getText();
				System.out.println(customer_Id);
				break;
			}
	}
	driver.findElement(By.xpath("//input[@name='staff_login-btn']")).click();
    driver.findElement(By.xpath("//input[@value='Delete Customer A/c']")).click();
    driver.findElement(By.xpath("//input[@placeholder='Customer Account No']")).sendKeys(num2);
    driver.findElement(By.xpath("//input[@placeholder='Customer ID']")).sendKeys(customer_Id);
    driver.findElement(By.xpath("//input[@placeholder='Reason']")).sendKeys("customer wants to close the account");
