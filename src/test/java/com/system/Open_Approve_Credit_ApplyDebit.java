...
public class Open_Approve_Credit_ApplyDebit {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.name("holder_name")).sendKeys("Jagadeesh Koti");
		driver.findElement(By.name("dob")).sendKeys("08-07-1996");
		driver.findElement(By.name("pan")).sendKeys("ECZPK0709M");
		driver.findElement(By.name("mob")).sendKeys("9686881058");
		driver.findElement(By.name("acc_no")).sendKeys("101141011762");
